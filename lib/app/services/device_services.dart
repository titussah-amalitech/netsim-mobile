 ...
 */
  static Future<({bool success, String message, List<Device> devices})>
  getDevices() async {
    await Future.delayed(const Duration(milliseconds: 100));
    try {
      final model = ScenarioModel.fromMap(
        dummyScenario as Map<String, dynamic>,
      );
      return (
        success: true,
        message: 'Devices retrieved from dummy data',
